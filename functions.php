...
function snaps_setup() {
	...
	$license_manager = new GPP_Updater(
		'snaps',      // The "slug" of the theme or plugin. This must match exactly the ZIP download slug.
		'Snaps',      // A pretty name for your plugin/theme. Used for settings screens.
		'snaps',      // The plugin/theme text domain for localization.
